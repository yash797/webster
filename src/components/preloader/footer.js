...
import logo from "./baker1.png"
import "./Preloader.css";

function footer() {
  return (
    <div className="yfooter">
      <div className=" w-full flex justify-center text-center p-4 py-8 md:py-16 md:px-12 bg-gradient-to-br from-orange-600/40 via-blue-400/20 to-red-400/20 backdrop-blur-lg">
          ...
          >
            <div className="w-full h-full flex justify-center items-center">
              <img
                ...
                className="mx-auto lg:w-[50rem] h-[300px] w-[300px] object-contain"
                src={logo}
                alt="logo"
              ></img>
            </div>
              ...
              <div className="w-full space-y-4 text-center ">
                ...
                <div className="space-y-2 text-center grid grid-col-1 justify-center">
                  ...
                  <div className=" font-medium space-x-2 flex">
                    <div>📭︎</div>
                    <a href="mailto:support@pictcsi.com">support@holmes.com</a>
                  </div>
                  <div className=" font-medium space-x-2 flex">
                    <div>📞</div>
